...
class Login(tk.Tk):
    ...
    def _crear_componentes(self):
        ...
        self.usuario_caja_texto = ttk.Entry(frame)
        self.usuario_caja_texto.grid(row=1,column=1,sticky=tk.E,padx=5,pady=5)

        #clave
        etiqueta_clave = ttk.Label(frame, text='Password', font=('Arial',16))
        etiqueta_clave.grid(row=2,column=0,sticky=tk.W,padx=5,pady=5)

        self.clave_caja_texto = ttk.Entry(frame,show='*')
        self.clave_caja_texto.grid(row=2,column=1,sticky=tk.E,padx=5,pady=5)
